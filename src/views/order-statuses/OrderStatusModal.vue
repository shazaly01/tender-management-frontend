<!-- src/views/order-statuses/OrderStatusModal.vue -->
<template>
  <div
    v-if="isOpen"
...
import OrderStatusForm from './OrderStatusForm.vue' // <-- استيراد النموذج
...
const title = computed(() =>
  props.status && props.status.id ? 'تعديل حالة طلب' : 'إضافة حالة طلب جديدة',
)
