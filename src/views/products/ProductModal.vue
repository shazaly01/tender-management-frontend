<!-- src/views/products/ProductModal.vue -->
<template>
  <div
    v-if="isOpen"
  ...
  >
    ...
    >
      ...
      <ProductForm :initial-data="productData" :is-saving="isSaving" @submit="handleFormSubmit" />
    </div>
  </div>
</template>
...
import ProductForm from './ProductForm.vue' // <-- استيراد النموذج
...
const title = computed(() => (props.product && props.product.id ? 'تعديل منتج' : 'إضافة منتج جديد'))
